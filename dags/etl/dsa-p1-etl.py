...
default_args = {
    'owner': 'acnaweb',                # Proprietário da DAG
...
dsa_cmd = BashOperator(
    task_id="dsa_cmd",                             # Identificador único para a tarefa
    bash_command="ls -la",                # Comando bash que será executado pela tarefa

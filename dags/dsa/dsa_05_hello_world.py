...
default_args = {
    ...
    "retry_delay": timedelta(
        minutes=5
    ),  # Definindo o intervalo de tempo entre as tentativas
}
...
with DAG(
    ...
    schedule_interval=timedelta(
        days=1
    ),  # Configurando a DAG para ser executada diariamente
    ...
    dsaTarefaD = BashOperator(
        task_id="dsaTarefaD", bash_command="echo Tarefa D Executada com Sucesso DSA!"
    )
